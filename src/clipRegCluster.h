...
#define QC_SEQSIM_RATIO_MATCH_THRES				(0.9f)
#define QC_SEQSIM_RATIO_MATCH_THRES2			(0.65f) // (0.75f), (0.7f) updated on 2025-03-02
...
private:
	vector<qcSigListVec_t*> queryClusterOp(vector<qcSigList_t*> &qcSigList_vec);
	void appendOverlapHangingReadsClipReg(vector<qcSigList_t*> &qcSigList_vec, vector<qcSigListVec_t*> &query_clu_vec);
	void sortQueryInfoByNumCategoryClipReg(vector<qcSigList_t*> &qcSigList_vec);
	void sortQueryInfoBySizeCategoryClipReg(vector<qcSigList_t*> &qcSigList_vec);
