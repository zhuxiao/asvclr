...
class localCns {
	public:
		...
		int32_t num_threads_per_cns_work, minClipEndSize, minConReadLen, maxVarRegSize, min_sv_size, min_supp_num, minMapQ: 16, minHighMapQ: 16, sv_len_est;
		double max_ultra_high_cov, max_seg_size_ratio, min_seqsim_match, max_seg_nm_ratio, max_absig_density;
	...
	private:
		...
		int32_t adjustMinSuppNumLowCov(int32_t min_supp_num_original, vector<struct querySeqInfoNode*> &query_seq_info_all);
