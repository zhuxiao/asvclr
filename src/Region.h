...
class Region {
	public:
		Paras *paras;
		string chrname;
		size_t startRPos, endRPos, startMidPartPos, endMidPartPos;
	...
	public:
		Region(string& chrname, size_t startRpos, size_t endRPos, Base *regBaseArr, size_t regFlag, Paras *paras);
		virtual ~Region();
