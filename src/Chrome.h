...
class Chrome{
	...
	//private:
		...
		// consensus info and misAln region
	...
	private:
		...
		void outputCnsDataToFile(string &filename);
		...
		void loadPrevMinimapAlnItems(bool clipReg_flag, bool limit_reg_process_flag, vector<simpleReg_t*> &limit_reg_vec);
